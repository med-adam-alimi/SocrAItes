...
class SocrAItesChat {
    ...
    showWelcomeMessage() {
        ...
        const welcomeMsg = this.createMessage(
            'ai',
            'Welcome to SocrAItes! I\'m here to discuss the deepest questions of existence, meaning, and human experience. Choose a philosopher from the header and ask me anything about life, consciousness, morality, or the human condition.',
            'AI Guide'
        );
