#!/usr/bin/env python3
"""
LangChain module - DISABLED to prevent import errors
This module is optional and not needed for core functionality
"""

# Disabled LangChain integration to prevent import issues
# The core system works perfectly with Groq API directly

LANGCHAIN_AVAILABLE = False
LANGCHAIN_ERROR = "LangChain module disabled - not needed for core functionality"

class LangChainPhilosopherChat:
    """Disabled LangChain class - use GroqPhilosopherChat instead"""
    
    def __init__(self):
        raise ImportError("LangChain module disabled. Use GroqPhilosopherChat instead.")

# Ensure this module doesn't break imports
def create_langchain_chat():
    raise ImportError("LangChain disabled - use Groq system instead")

if __name__ == "__main__":
    print("⚠️ LangChain module disabled to prevent import issues")
    print("✅ Use GroqPhilosopherChat for all functionality")
...
class LangChainPhilosopherChat:
    ...
    def __init__(self):
        if not LANGCHAIN_AVAILABLE:
            raise ImportError("LangChain not available. This module is optional.")
